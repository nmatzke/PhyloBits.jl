...
#------------------------------------
function citation()
    println("If you use PhyloBits, the phylogeny reading/writing/types codes comes from PhyloNetworks, so please cite:")
    println("Claudia Solís-Lemus, Paul Bastide, Cécile Ané, PhyloNetworks: A Package for Phylogenetic Networks, Molecular Biology and Evolution, 34(12), 3292-3298. https://doi.org/10.1093/molbev/msx235")
    println("\n")
    ...
    println("doi = {10.1093/molbev/msx235}}")
    println("\n")
    println("doi = {}}")
end
